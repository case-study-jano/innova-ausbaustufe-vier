...
@Component
public class AddInnovationApprovedPointsDelegate implements JavaDelegate {

    private final ScoreServiceExternal scoreService;
    private final InnovationProposalRepository innovationProposalRepository;

    @Autowired
    public AddInnovationApprovedPointsDelegate(InnovationProposalRepository innovationProposalRepository, ScoreServiceExternal scoreService) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        scoreService.updateScoreInnovationApproved(creatorName);
    }
}
